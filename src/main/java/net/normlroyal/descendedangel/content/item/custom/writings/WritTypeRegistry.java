...
import net.normlroyal.descendedangel.content.item.custom.writings.effects.SpawnEntityWritType;
import net.normlroyal.descendedangel.content.item.custom.writings.effects.SpawnStructureWritType;
import net.normlroyal.descendedangel.content.item.custom.writings.effects.WeatherWritType;
