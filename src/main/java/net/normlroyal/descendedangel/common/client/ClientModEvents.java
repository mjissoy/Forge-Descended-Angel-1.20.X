...
import net.normlroyal.descendedangel.content.block.ModBlockEntities;
import net.normlroyal.descendedangel.common.client.animation.ModPlayerAnimations;
import net.normlroyal.descendedangel.common.client.render.AltarRenderer;
